...
export default function SignupPage() {
  ...
  useEffect(() => {
    if (!auth) {
      ...
      setError("Firebase is not configured. Please add your Firebase project credentials to the environment variables to enable signup.");
    }
  }, []);
  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>Choose a method to start your learning journey.</CardDescription>
      </CardHeader>
      <CardContent className="space-y-4">
        {error && (
            <Alert variant="destructive">
               <AlertTitle>{!firebaseConfigured ? "Configuration Error" : "Signup Failed"}</AlertTitle>
        ...
        <form onSubmit={handleSignup} className="space-y-4">
          ...
          <div className="space-y-2">
            ...
            <Input id="password" name="password" type="password" value={password} onChange={e => setPassword(e.target.value)} required minLength={6} disabled={!firebaseConfigured || loading || googleLoading} />
